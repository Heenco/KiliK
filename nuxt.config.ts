...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    pythonServiceUrl: process.env.PYTHON_SERVICE_URL || 'https://streamlit-pdf-processor.onrender.com',
    ...
    public: {
      ...
      OPENAI_API_KEY: process.env.NUXT_PUBLIC_OPENAI_API_KEY || 'sk-proj-483k1MIC4VGgRNS4gg0fJOKQIKk4s-LuJqbn7eKUVC_AqXWuA7yjWFSwF3Q_-Pwq7CLGQMGLKuT3BlbkFJ4ceAQonpns_J7ZM9j43YiP2WR-JrQjRAfYdvhjl61NoLewj-sQEcbk5XESQFSZtl2Eg_Rm_cA',
